...
const val KEY_CURRENT_DESSERT = "key_current_dessert"
...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            ...
            binding.dessertButton.setImageResource(savedInstanceState.getInt(KEY_CURRENT_DESSERT))
        }
    ...
    override fun onSaveInstanceState(outState: Bundle?) {
        ...
        outState?.apply {
            ...
            putInt(KEY_CURRENT_DESSERT, currentDessert.imageId)
        }
